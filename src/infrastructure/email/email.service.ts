...
`,
  ...
  async sendPasswordResetEmail(to: string, token: string) {
    ...
    const baseUrl = this.config.get<string>('RESET_PASSWORD_URL');
...
<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-2qlfkicae-resend.vercel.app/static/dropbox-logo.png" />
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
    <!--$-->
  </head>
        ...
        <tr style="width:100%">
          <td>
            <img
              alt="Dropbox"
              height="33"
              src="https://react-email-demo-2qlfkicae-resend.vercel.app/static/dropbox-logo.png"
              style="display:block;outline:none;border:none;text-decoration:none"
              width="40" />
            <table
              align="center"
              ...
              <tbody>
                <tr>
                  <td>
                    <p
                      style="font-size:16px;line-height:26px;font-family:&#x27;Open Sans&#x27;, &#x27;HelveticaNeue-Light&#x27;, &#x27;Helvetica Neue Light&#x27;, &#x27;Helvetica Neue&#x27;, Helvetica, Arial, &#x27;Lucida Grande&#x27;, sans-serif;font-weight:300;color:#404040;margin-bottom:16px;margin-top:16px">
                      Hi
                      <!-- -->Alan<!-- -->,
                    </p>
                    <p
